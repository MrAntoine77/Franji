...
fun SearchKanjiScreen(
    ...
    var kanji_list by remember { mutableStateOf<List<Kanji>>(emptyList()) }
    ...
    Scaffold(
        ...
        LaunchedEffect(search_text) {
            ...
            kanji_list = if (search_text.isNotEmpty()) {
        ...
        Box(
            ...
            when {
                ...
                kanji_list.isEmpty() && search_text.isNotEmpty() -> {
                    Box(
                        modifier = Modifier.fillMaxWidth(),
                        contentAlignment = Alignment.Center
                    ) {
                ...
                search_text.isNotEmpty() -> {
                    LazyVerticalGrid(
                        ...
                        items(kanji_list, key = { it.id }) { kanji ->
